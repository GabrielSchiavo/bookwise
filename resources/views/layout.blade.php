...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="/assets/images/favicons/favicon-48x48.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/assets/images/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/assets/images/favicons/favicon-192x192.png">
            ...
            <li>
                <button class="option-side-menu" id="switch-mode" title="Alterar Tema Claro/Escuro">
                    <div class="switch-mode-option">
                        <img id="svg-change-color" class="svg-color svg-icon-size" src="/assets/images/icons/icon-moon.svg" alt="Ícone Lua">
                        <span class="text text-ellipsis">Modo Escuro</span>
                    </div>
                    <div class="switch-mode-option">
                        <img id="svg-change-color" class="svg-color svg-icon-size" src="/assets/images/icons/icon-sun.svg" alt="Ícone Sol">
    ...
    <section id="content">
        ...
        <nav>
            <a id="btn-menu" title="Abrir/Fechar Menu">
                <img id="svg-change-color" class="svg-color svg-icon-size-medium" src="/assets/images/icons/icon-menu.svg" alt="Ícone Menu">
            </a>
